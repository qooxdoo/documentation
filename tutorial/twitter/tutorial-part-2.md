...
But a layout without any content is boring so we should add some
...
The first line tells the layout to keep the second row (the row for
...
This time, we call the `fireDataEvent` method to get a data event
