...
This is a quick reference for the various property features available
in Qooxdoo.
...
quick reference for properties_decl (expressed in an [EBNF-like syntax](../ebnf_like.md)
            way):
