...
This API is an improvement over the original
[`qx.io.remote.*` API](remote_io.md) , but does not offer the same feature-set
yet. It is recommended to use the classes in this API for your development.
The  
...
- **fail**: Any kind of error occurred. Catches distinct events `error`,
