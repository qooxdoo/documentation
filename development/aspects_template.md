...
Here is a code template which you may copy to your application
namespace and adapt it to implement aspects in your Qooxdoo
application. For a far more advanced sample look at qx.dev.Profile.
...
look at the tool/generator/generator_config_ref.
