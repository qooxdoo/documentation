...
Most of the time only the bubbling phase is used but sometimes the
...
To handle character inputs e.g. on text boxes, there is a special `
...
Furthermore you are able to block even the active command group by the
